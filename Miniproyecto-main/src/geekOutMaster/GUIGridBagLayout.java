...
public class GUIGridBagLayout extends JFrame{
    ...
    private JButton lanzar, ayuda, botonExplicacion, continuarReiniciar;
    ...
    /**
     * Este método se utiliza para establecer la configuración inicial y predeterminada de un componente de la interfaz grafica de usuario(JComponent),
     * Además creaa objetos de escucha y control que se usaran en la clase GUI
     */
    private void initGUI() {
        ...
        ayuda.setFont(new Font("Arial", Font.PLAIN, 18));
        ...
        botonExplicacion.setForeground(Color.WHITE);
        botonExplicacion.setFont(new Font("Arial", Font.PLAIN, 18));
        ...
        lanzar.setFont(new Font("Arial", Font.PLAIN, 18));
        ...
        /**
         * Creacion del panel Dado activos
         */
        panelDadoActivos = new JPanel();
        panelDadoActivos.setPreferredSize(new Dimension(400,250));
        panelDadoActivos.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.WHITE, 5),
        ...
        /**
         * Creacion del panel Dado inactivos
         */
        panelDadoInactivos = new JPanel();
        panelDadoInactivos.setPreferredSize(new Dimension(400,250));
        panelDadoInactivos.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.WHITE, 5),
                "Dados Inactivos", TitledBorder.CENTER, TitledBorder.TOP, new Font("Arial", Font.BOLD, 25), Color.RED));
        ...
        /**
         * Creacion del panel Dado utilizados
         */
        panelDadoUtilizados = new JPanel();
        panelDadoUtilizados.setPreferredSize(new Dimension(400,250));
        panelDadoUtilizados.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.WHITE, 5),
        ...
        /**
         * Creacion del panel puntaje
         */
        panelPuntaje = new JPanel();
        panelPuntaje.setLayout(new GridLayout(0,1));
        panelPuntaje.setPreferredSize(new Dimension(308,80));
        panelPuntaje.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.WHITE, 1),
                "Puntaje", TitledBorder.CENTER, TitledBorder.TOP, new Font("Arial", Font.BOLD, 15), Color.WHITE));
        ...
        /**
         *  Creacion del panel ronda
         */
        panelRonda = new JPanel();
        panelRonda.setPreferredSize(new Dimension(308,50));
        panelRonda.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.WHITE, 1),
                "Ronda", TitledBorder.CENTER, TitledBorder.TOP, new Font("Arial", Font.BOLD, 15), Color.WHITE));
        panelRonda.setBackground(new Color(255,255,255,0));
        panelRonda.setForeground(Color.WHITE);
        constraints.gridx=3;
        constraints.gridy=4;
        constraints.gridwidth=3;
        constraints.fill=GridBagConstraints.CENTER;
        ...
        continuarReiniciar.setForeground(Color.white);
        ...
        /**
         * Creamos el mensaje de atención
         */
        mensajesSalida= new JTextArea(3,30);
        mensajesSalida.setText("Usa el botón (Ayuda) para ver las reglas del juego");
        mensajesSalida.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.WHITE, 1),
                "Atención ", TitledBorder.CENTER, TitledBorder.TOP, new Font("Arial", Font.BOLD, 15), Color.WHITE));
        mensajesSalida.setEditable(false);
        mensajesSalida.setForeground(Color.white);
     ...
     * @param args Objeto usado para recibir informacion de entrada
     *             desde la linea de comandos cuando el programa se ejecuta desde la consola.
     */
    ...
    /**
     * Se actualiza el panel correspondiente
     * @param nombrePanel
     */
    ...
    /**
     *Obtiene la ronda actual, el puntaje de cada ronda y el puntaje total
     */
    public void rondas(){
        int Dado42 = 0; // 42
    ...
    private class Escucha implements ActionListener, MouseListener {
        ...
        /**
         * Uso de Mouse Clicked para los Dado
         * @param e
         */
        @Override
        public void mouseClicked(MouseEvent e) {
